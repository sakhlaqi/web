    ...
    async function checkSubDomain() {
      if (debouncedSubdomain.length > 0) {
        ...
        if (available) {
          ...
          setError(`${debouncedSubdomain}.${process.env.ROOT_DOMAIN}`);
        }
      }
    }
    checkSubDomain();
  ...
  return (
    <Layout>
      <Modal showModal={showModal} setShowModal={setShowModal}>
        ...
        >
          <h2 className="font-cal text-2xl mb-6">Create a New Site {process.env.ROOT_DOMAIN}</h2>
                    ...
                    <div className="flex flex-col md:flex-row md:h-60 rounded-lg overflow-hidden border border-gray-200">
                      ...
                      <div className="relative p-10">
                        ...
                        <a
                          ...
                          href={`http://${site.subdomain}.${process.env.ROOT_DOMAIN}`}
                          onClick={(e) => e.stopPropagation()}
                          rel="noreferrer"
                          target="_blank"
                        >
                          {site.subdomain}.{process.env.ROOT_DOMAIN} ↗
                        </a>
                      </div>
                    </div>
                  </a>
